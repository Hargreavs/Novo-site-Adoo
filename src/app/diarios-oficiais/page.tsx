...
export default function DiariosOficiais() {
  ...
  return (
    <div className="bg-transparent min-h-screen">
      ...
      {/* Toast Notification */}
      {showToast && (
        <div className="fixed top-36 right-4 z-50 animate-in slide-in-from-top-2 duration-300">
          <div className="bg-blue-600/20 border-blue-500/30 text-blue-300 px-6 py-3 rounded-lg shadow-lg border backdrop-blur-sm flex items-center gap-3">
